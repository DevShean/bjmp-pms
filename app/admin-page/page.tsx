...
function StatCard({ 
  ...
  return (
    <Link href={href} className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-blue-200 hover:shadow-md active:scale-[0.98]">
      ...
      <div className="mt-auto pt-4 flex items-center gap-1 text-xs font-medium text-blue-600 transition-all group-hover:gap-2">
        ...
        <header className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-sm">
            ...
            <div className="min-w-0">
              <p className="text-[10px] font-medium text-slate-500 leading-none">System Time</p>
